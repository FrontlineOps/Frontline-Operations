...
private _forwardPos = _anchorPos getPos [abs _resolvedDepthOffset, _facingDir + ([180, 0] select (_resolvedDepthOffset >= 0))];
private _candidatePos = _forwardPos getPos [abs _resolvedLateralOffset, _facingDir + ([270, 90] select (_resolvedLateralOffset >= 0))];
