...
switch _role do {
    case "road": {
...

        {
            ...
            {
                private _mineType = ["APERSMine", "APERSBoundingMine"] select ((random 1) > 0.6);
                _slotPlans pushBack (createHashMapFromArray [
                    ["type", _mineType],
                    ["depthOffset", _depthOffset],
                    ["lateralOffset", _x],
    ...
    case "bypass": {
        ...
        for "_layerIndex" from 0 to (_packetLayers - 1) do {
            ...
            private _mineType = ["APERSBoundingMine", "APERSMine"] select ((_layerIndex mod 2) == 0);
    ...
    default {
        ...
        for "_layerIndex" from 0 to (_packetLayers - 1) do {
            ...
            private _mineType = ["APERSMine", "APERSBoundingMine"] select ((_layerIndex mod 3) == 1);
