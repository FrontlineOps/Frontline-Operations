...

{
    ...
    private _markerPos = [_position, [_position, _groupId, _precision] call FLO_fnc_gtnApproximateCommanderMarkerPosition] select (_precision > 0);

    private _alpha = [0.7, 0.42] select (_precision > 0);
