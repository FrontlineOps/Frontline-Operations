...
_cache set ["home", if (_homePositions isNotEqualTo []) then { _homePositions } else { [_objectivePos] }];
_cache set ["market", if (_marketPositions isNotEqualTo []) then { _marketPositions } else { [_objectivePos] }];
_cache set ["work", if (_workPositions isNotEqualTo []) then { _workPositions } else { [_objectivePos] }];
_cache set ["observe", if (_intersectionPositions isNotEqualTo []) then { _intersectionPositions } else { [_objectivePos] }];
_cache set ["shelter", if (_shelterPositions isNotEqualTo []) then { _shelterPositions } else { [_objectivePos] }];
_cache set ["parking", if (_roadPositions isNotEqualTo []) then { _roadPositions } else { [_objectivePos] }];
