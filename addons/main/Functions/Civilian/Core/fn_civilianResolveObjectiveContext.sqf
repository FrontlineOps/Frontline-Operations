...
private _friendlyCountKey = ["opforCount", "bluforCount"] select (_reportingSide isEqualTo west);
private _enemyCountKey = ["bluforCount", "opforCount"] select (_reportingSide isEqualTo west);
