...

{
    ...
    private _objData = createHashMapFromArray [
        ...
        ["captureProgress", 0],
        ["captureState", "held"],
        ["captureSide", sideUnknown],
        ["captureSecureStartedAt", -1],
        ["captureSecureProgress", 0],
        ["captureStatusChangedAt", -1],
        ["captureIntegratedAtDateNum", -1],
        ["bluforCount", 0],
        ["opforCount", 0],
        ["contested", false],
        ["underAttack", false],
...
{
    _allObjectives set [_x, [_x, _allObjectives get _x] call FLO_fnc_objectiveDevelopmentInitializeObjective];
} forEach _keys;
