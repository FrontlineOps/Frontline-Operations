...
private _containerActions = if (_actionPrefix isEqualTo "FOB") then {
    ...
    [
        ...
        ["<img size=2 color='#FFE496' image='\z\flo\addons\main\Screens\FOBA\b_hq.paa'/><t font='PuristaBold' color='#FFE496'>SAVE Mission Progress", { [player] remoteExec ["FLO_fnc_saveRequest", 2]; }, nil, 6, true, true, "", _commanderCondition],
