...

{
    ...
    if (
        ...
        || {([_groupData] call FLO_fnc_virtualizationGetTransportPassengers) isNotEqualTo []}
...

{
    ...
    private _hasPassengers = ([_groupData] call FLO_fnc_virtualizationGetTransportPassengers) isNotEqualTo [];
