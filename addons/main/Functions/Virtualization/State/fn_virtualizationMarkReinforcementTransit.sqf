...
_candidate set ["replacementState", "REINFORCE"];
[_candidate, "LOGISTICS", "REINFORCE"] call FLO_fnc_virtualizationSetMissionLock;
...
[_candidate] call FLO_fnc_virtualizationClearAADeployState;
