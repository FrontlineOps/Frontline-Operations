...
if (_carrierVehicles isEqualTo []) then {
...
[_passengerGroupId] call FLO_fnc_virtualizationUnlinkTransportGroups;
if ((_passengerData get "missionLock") == "TRANSPORT") then {
    [_passengerGroupId, createHashMapFromArray [
        ["missionLock", ""],
        ["missionType", ""]
...
if (_carrierVehicles isNotEqualTo []) then {
...
[_passengerGroupId, _dropPos] call FLO_fnc_virtualizationUpdateGroupPosition;
