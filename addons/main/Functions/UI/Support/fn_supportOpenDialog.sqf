...
_browser ctrlAddEventHandler [_webDialogEvent, FLO_fnc_supportHandleUiEvent];
[_browser, ["LoadFile", "\z\flo\addons\main\UI\Support\index.html"]] call FLO_fnc_uiWebAction;
