...
// TEXT SIZES
// ============================================================================
// Grid macros are provided by the Arma includes above.
#define GUI_TEXT_SIZE_SMALL  "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)"
#define GUI_TEXT_SIZE_MEDIUM "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1.0)"
#define GUI_TEXT_SIZE_LARGE  "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1.2)"
