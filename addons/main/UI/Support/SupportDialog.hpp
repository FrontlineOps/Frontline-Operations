#define FLO_SUPPORT_CT_WEBBROWSER 106

class FLO_SupportDialog {
    idd = 9970;
    movingEnable = 0;
    enableSimulation = 1;
    onUnload = "uiNamespace setVariable ['FLO_SupportControl', controlNull]; uiNamespace setVariable ['FLO_SupportMapControl', controlNull]; FLO_SupportBrowserReady = false; FLO_SupportTargetPosition = []";

    class Controls {
        class Browser: RscText {
            idc = 9971;
            type = FLO_SUPPORT_CT_WEBBROWSER;
            style = 0;
            x = "safeZoneX";
            y = "safeZoneY";
            w = "safeZoneW";
