...
private _attachments = [
    ...
    "NMG_silence_pbs_ATGsil",
    "NMG_silence_no4762",
    "NMG_silence_dtk_gexagonAK",
    "NMG_silence_dtk3",
    "NMG_silence_dtk2",
    "NMG_silence_dtk1l",
    "NMG_silence_dtk_ak200",
    "NMG_silence_dtk_6ch63doj",
    "NMG_silence_dtk_6ch63",
    "NMG_silence_dtkPaek",
    "NMG_silence_dtk41m",
    // Optics
    "rhs_acc_pso1m2",
    ...
    "rhs_weap_optic_smaw",
    "Leupold_Mk4",
    "NMG_acc_sgh_ElFalcon_wi",
    "NMG_acc_sgh_kobra8m_wi",
    "NMG_acc_sgh_vortexUh1_wi",
    "NMG_acc_sgh_rakurs_w",
    "NMG_acc_sgh_p142x_wi",
    "NMG_acc_sgh_okp3",
    "NMG_acc_sgh_pilad_brevis_wi",
    "NMG_acc_sgh_ps320_wi",
    "NMG_acc_sgh_KHS",
    "NMG_acc_sgh_ERCO",
    "NMG_acc_sgh_vld_magnif_dwn_wi",
    "NMG_acc_sgh_vld_PNV_dwn_wi",
    "NMG_acc_sgh_acpoint39_wi",
...
private _magazines = [
    ...
    "30rnd_762ak_bakel_trs_green_nmg",
    "30rnd_762ak_bakel_trs_nmg",
    "30rnd_762ak_bakel_nmg",
    "rhs_30Rnd_762x39mm",
    "rhs_30Rnd_762x39mm_89",
    "100Rnd_762pk_nmg",
    "100Rnd_762ak_trs_nmg",
