...
(_display displayCtrl 2095) ctrlSetBackgroundColor (if (_objectiveVisible) then {[0.35, 0.35, 0.35, 1]} else {[0.20, 0.20, 0.20, 1]});

uiNamespace setVariable ["FLO_FactionCompositionTab", if (_objectiveVisible) then {"objectives"} else {"composition"}];
