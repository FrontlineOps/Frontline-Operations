    ...
    ["_registerHandlers", {
        ...
        _self call ["_registerHandler", ["prim_request_air_recon", {
            ...
            [_gtnCmdr, _objId, _objPos, _groupId, _mgr, _aircraft] spawn {
                ...
                ["GTN", 3, format["Legitimate Air Recon for %1: Saw %2 units. Power: %3. AA: %4. Posture: %5", 
                     _objId, 
        ...
        _self call ["_registerHandler", ["prim_call_cas_coord", {
            ...
            // Request CAS via GTN Commander
            // Note: _requestCAS usually expects ObjPos, but coordinate is fine if function supports it
            // Assuming _requestCAS just passes position to manager
        ...
        _self call ["_registerHandler", ["prim_assault_coord", {
            ...
            private _taskNode = _ctx get "taskNode";
            private _primData = _taskNode getOrDefault ["primitiveData", createHashMap];
            _primData set ["arrived", true]; // Immediate success for ordering
            _taskNode set ["primitiveData", _primData];
