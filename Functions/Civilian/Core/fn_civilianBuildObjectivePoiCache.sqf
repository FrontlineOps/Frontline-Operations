...
if ((count _buildingPositions) == 0) then {
    _buildingPositions pushBack _objectivePos;
};
if ((count _roadPositions) == 0) then {
    _roadPositions pushBack _objectivePos;
};
if ((count _intersectionPositions) == 0) then {
    _intersectionPositions = +_roadPositions;
};
if ((count _marketPositions) == 0) then {
...
if ((count _workPositions) == 0) then {
    _workPositions = +_roadPositions;
};

_cache set ["objectivePos", _objectivePos];
_cache set ["home", if ((count _homePositions) > 0) then { _homePositions } else { [_objectivePos] }];
_cache set ["market", if ((count _marketPositions) > 0) then { _marketPositions } else { [_objectivePos] }];
_cache set ["work", if ((count _workPositions) > 0) then { _workPositions } else { [_objectivePos] }];
_cache set ["observe", if ((count _intersectionPositions) > 0) then { _intersectionPositions } else { [_objectivePos] }];
_cache set ["shelter", if ((count _shelterPositions) > 0) then { _shelterPositions } else { [_objectivePos] }];
_cache set ["parking", if ((count _roadPositions) > 0) then { _roadPositions } else { [_objectivePos] }];
